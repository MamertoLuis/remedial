...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Attempting to import loan account data from {csv_file_path}...'))
                    ...
                    try:
                        with transaction.atomic():
                            ...
                            try:
                                ...
                                raise ValueError(f"Borrower with borrower_id '{borrower_id}' does not exist.")
