...
class CompromiseAgreementTests(TestCase):
    ...
    def test_compromise_agreement_list_view(self):
        ...
        self.assertTemplateUsed(
            response, "compromise_agreement/compromise_agreement_list.html"
        )
    ...
    def test_compromise_agreement_create_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "compromise_agreement/compromise_agreement_form.html"
        )
        ...
        )  # Should redirect to account detail view
    ...
    def test_compromise_agreement_detail_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "compromise_agreement/compromise_agreement_detail.html"
        )
    ...
    def test_compromise_agreement_update_view(self):
        ...
        self.assertEqual(
            self.compromise_agreement.approved_compromise_amount, updated_amount
        )
    ...
    def test_compromise_installment_create_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "compromise_agreement/compromise_installment_form.html"
        )
        ...
        self.assertEqual(
            new_installment.compromise_agreement, self.compromise_agreement
        )
